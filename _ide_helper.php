...
namespace Bogardo\Mailgun\Facades {
    ...
    class Mailgun {
         ...
         * @static 
         */
        public static function send($view, $data, $callback, $mustInit = true)
        {
            return \Bogardo\Mailgun\Mailgun::send($view, $data, $callback, $mustInit);
        }
        ...
        {
            return \Bogardo\Mailgun\Mailgun::validate($address);
        }
         ...
         * @static 
         */
        public static function parse($addresses, $syntaxOnly = true)
        {
            return \Bogardo\Mailgun\Mailgun::parse($addresses, $syntaxOnly);
        }
         ...
         * @static 
         */
        public static function optInHandler()
        {
            return \Bogardo\Mailgun\Mailgun::optInHandler();
        }
         ...
         * @param bool $init
         * @param string $apiKey
         * @return \Bogardo\Mailgun\Mailgun\MailgunCore 
         * @static 
         */
        public static function mailgun($init = false, $apiKey = '')
        {
            //Method inherited from \Bogardo\Mailgun\Mailgun\MailgunApi            
            return \Bogardo\Mailgun\Mailgun::mailgun($init, $apiKey);
        }
...
namespace {
    ...
    class Helper extends \App\Classes\Helper {}
    
    class LMenu extends \Lavary\Menu\Facade {}
    ...
    class Mailgun extends \Bogardo\Mailgun\Facades\Mailgun {}
